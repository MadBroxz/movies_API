...
Este es un proyecto de una API para gestionar películas, actores, directores y géneros montada en un servidor Express con sequelize con configuraciones comunes. Utiliza las siguientes librerías:
